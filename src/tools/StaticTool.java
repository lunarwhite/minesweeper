 ...
 *
 * Define all the static variables and methods.
 *
 * It uses HeroBean objects.
 */
...
public class StaticTool {
  ...
  public static int bombCount = allcount;   //may change if bombs are laid
  ...
  static {
    treeSetC.add(new HeroBean(999, "TestUser01"));
    treeSetZ.add(new HeroBean(999, "TestUser02"));
    treeSetG.add(new HeroBean(999, "TestUser03"));
  }

  /**
   * Parameters: null
   * get the game level(mode) from the static values.
